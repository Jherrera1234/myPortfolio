      ...
      <div className='project-div'>
        ...
        <div className='project-1'>
          ...
          <div className='projects-links'>
            <a className='projects' href="https://github.com/Jherrera1234/APB">View Code</a>
            <a className='projects' href="https://apb-auto.netlify.app/">View Site</a>
          </div>
        </div>
        ...
        <div className='project-2'>
          ...
          <div className='projects-links'>
            <a className='projects' href="https://github.com/yeana-dev/YSFJ">View Code</a>
            <a className='projects' href="https://ysfj.netlify.app/">View Site</a>
          </div>
        </div>
        ...
        <div className='project-3'>
          ...
          <div className='projects-links'>
            <a className='projects' href="https://github.com/Jherrera1234/AniTracker">View Code</a>
            <a className='projects' href="https://anitrackers.netlify.app/">View Site</a>
          </div>
        </div>
